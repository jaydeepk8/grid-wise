export default function Working() {
  ...
  return (
    <section className="bg-[#f1f4f1] py-16 md:py-24 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12 md:mb-20">
          ...
          <h2
            className="text-3xl sm:text-4xl md:text-5xl text-[#2d3a2d]"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12">
          {steps.map((step, i) => (
            <div key={i} className="flex flex-col items-center text-center">
              ...
              <div className="w-24 h-24 md:w-28 md:h-28 rounded-full bg-[#e8ede6] flex items-center justify-center mb-6 md:mb-8">
                <span className="material-symbols-outlined text-[#4a6741] text-4xl">
                  {step.icon}
                </span>
              </div>

              <div className="w-12 h-px bg-[#4a6741]/30 mb-5 md:mb-6" />
