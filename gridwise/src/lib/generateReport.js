export async function generateReport(facility) {
  ...
  function addFooters() {
    ...
    for (let i = 1; i <= pageCount; i++) {
      ...
      doc.setFont("helvetica", "normal");
      doc.text("Generated by Lumiq Systems — AI-Powered Energy Prediction and Management", 14, pageHeight - 6);
  ...
  addFooters();
  doc.save(`Lumiq_${facility.name.replace(/\s+/g, "_")}_Report.pdf`);
}